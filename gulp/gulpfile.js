...
const glob = require("gulpsassglob");
const postcss = require("gulppostcss");
const autoprefixer = require("autoprefixer");
const plumber = require("gulpplumber");
const notify = require("gulpnotify");
const htmlmin = require("gulphtmlmin");
const del = require("del");
const ejs = require("gulpejs");
const concat = require("gulpconcat");
const order = require("gulporder");
const rename = require("gulprename");
const cleanCSS = require("gulpcleancss");
const pngquant = require("imageminpngquant");
const imagemin = require("gulpimagemin");
const mozjpeg = require("imageminmozjpeg");
const uglify = require("gulpuglify");
const browserSync = require("browsersync");
const replace = require("gulpreplace");

//開発と本番で処理を分ける
//今回はhtmlの処理のところで使っています
const mode = require("gulpmode")({
...
// 参考サイト
// https://yumegori.com/gulp4setting20191025#chapter0
